      ...
      <div className="container mx-auto">
        ...
        <div className="flex items-center xl:h-[960px]">
          ...
          <div className="w-full xl:max-w-[460px] text-center xl:text-left">
            ...
            >
              by: <span className="text-orange"> Chinese Cuisine</span>
            </motion.p>
            <motion.p
            ...
            >
              Discover a world of traditional dishes crafted with passion and served with elegance. From savory dumplings to aromatic noodles, each bite brings you closer to the heart of Chinese culinary artistry.
            </motion.p>
            <motion.div
